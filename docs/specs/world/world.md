...
- [x] Yard landscaping (trees/planters) placed procedurally per lot, seeded/deterministic, collision-aware against the house/walkway/fence and each other ([#170](https://github.com/derekwinters/lucas-doggiehood/issues/170))
