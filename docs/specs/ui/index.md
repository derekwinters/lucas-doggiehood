...
- [Debug tuning menu](debug-tuning-menu.md) — a **dev-build-only** utilitarian overlay exposing the Core `TuningConfig` balance values as grouped sliders (Pacing · Economy · Expansion · Move-in), with per-group and global reset; reached from a "Tune balance…" row in the Settings Debug tab, layered over Settings as a centered modal ([#621](https://github.com/derekwinters/lucas-doggiehood/issues/621), consumer [#622](https://github.com/derekwinters/lucas-doggiehood/issues/622), over `TuningConfig` [#620](https://github.com/derekwinters/lucas-doggiehood/issues/620)).
