...
- [Dog Profile](dog-profile.md) — the centered profile card opened by tapping a dog ([#177](https://github.com/derekwinters/lucas-doggiehood/issues/177)).
- [Settings menu](settings.md) — sidebar tabs with an About tab (version) and a hidden Debug tab revealed by a 10-tap unlock ([#218](https://github.com/derekwinters/lucas-doggiehood/issues/218)).
- [House profile](house-profile.md) — the centered profile card opened by tapping a house: level, resident-dog links, and an upgrade entry point ([#293](https://github.com/derekwinters/lucas-doggiehood/issues/293), unblocks [#208](https://github.com/derekwinters/lucas-doggiehood/issues/208)).
- [Confirmation dialog](confirmation-dialog.md) — a reusable Yes/No confirmation overlay with dynamic text and an optional coin cost on Yes; first used by the map-expansion zone unlock ([#344](https://github.com/derekwinters/lucas-doggiehood/issues/344), consumer [#343](https://github.com/derekwinters/lucas-doggiehood/issues/343)).
- [Onboarding reward panel](onboarding-reward.md) — a bespoke celebration panel raised on completing each onboarding step, calling out the coin reward; the one standard reward surface reused across all onboarding flows ([#374](https://github.com/derekwinters/lucas-doggiehood/issues/374), consumer [#372](https://github.com/derekwinters/lucas-doggiehood/issues/372)).
- [Welcome pop-up](welcome-popup.md) — a modal celebration panel raised when a new dog or household moves into a vacant house; reuses the reward-panel composition, adds a per-dog member-chip row, and its "Say hi!" button pans the camera to the new house ([#439](https://github.com/derekwinters/lucas-doggiehood/issues/439)).
- [Toast notification](toast.md) — a non-modal top-left toast celebrating quest completion and onboarding reward-chain step completion; auto-timeout + tap-to-dismiss, a single sequential-queue slot ([#562](https://github.com/derekwinters/lucas-doggiehood/issues/562), consumer [#541](https://github.com/derekwinters/lucas-doggiehood/issues/541)).
- [Debug tuning menu](debug-tuning-menu.md) — a utilitarian overlay exposing the Core `TuningConfig` balance values as grouped sliders (Pacing · Economy · Expansion · Move-in), with per-group and global reset; reached from a "Tune balance…" row in the Settings Debug tab behind the 10-tap Debug unlock — its only gate ([#656](https://github.com/derekwinters/lucas-doggiehood/issues/656)) — and layered over Settings as a centered modal ([#621](https://github.com/derekwinters/lucas-doggiehood/issues/621), consumer [#622](https://github.com/derekwinters/lucas-doggiehood/issues/622), over `TuningConfig` [#620](https://github.com/derekwinters/lucas-doggiehood/issues/620)).

*Per-screen wireframes are added here as they're approved (tracked under epic [#171](https://github.com/derekwinters/lucas-doggiehood/issues/171): [#173](https://github.com/derekwinters/lucas-doggiehood/issues/173) shared components, [#174](https://github.com/derekwinters/lucas-doggiehood/issues/174) HUD currency chip, [#175](https://github.com/derekwinters/lucas-doggiehood/issues/175) conversation panel, [#176](https://github.com/derekwinters/lucas-doggiehood/issues/176) onboarding overlay, [#177](https://github.com/derekwinters/lucas-doggiehood/issues/177) dog profile view, [#218](https://github.com/derekwinters/lucas-doggiehood/issues/218) settings menu, [#293](https://github.com/derekwinters/lucas-doggiehood/issues/293) house profile view, [#344](https://github.com/derekwinters/lucas-doggiehood/issues/344) confirmation dialog, [#374](https://github.com/derekwinters/lucas-doggiehood/issues/374) onboarding reward panel).*
