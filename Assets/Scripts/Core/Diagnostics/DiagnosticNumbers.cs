...
{
    /// <summary>
    /// #692/#161: the named numbers the diagnostic-report payload is sized by —
    /// never bare literals in a method body.
    /// </summary>
    public static class DiagnosticNumbers
    {
        ...
        /// <c>REPORT</c> header. Bumped when the section set or line shapes
        /// change, so an old report is recognizable as an old format.</summary>
