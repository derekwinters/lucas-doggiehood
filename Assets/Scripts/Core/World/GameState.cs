...
namespace Doggiehood.Core.World
{
    ...
    public sealed class GameState
    {
        ...
        /// <para>#692: made readable so the bug-report snapshot
        /// (<see cref="Diagnostics.DiagnosticReport"/>) can quote the next
        /// unlock's real price through the same seam the unlock charges, rather
        /// than re-deriving the road/green-space split and drifting from
        /// it.</para></summary>
