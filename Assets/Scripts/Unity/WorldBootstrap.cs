...
namespace Doggiehood.Unity
{
    ...
    public sealed class WorldBootstrap : MonoBehaviour
    {
        private void Awake()
        {
            ...
            // Wired here because this is where the two scene-only facts are in
            // hand — the buffered log tail, and the dogs' on-screen positions.
            ...
            // the one toast trigger that is a debug confirmation rather than a
            // player reward, and reachable only behind the 10-tap Debug unlock
            // (docs/specs/ui/toast.md).
