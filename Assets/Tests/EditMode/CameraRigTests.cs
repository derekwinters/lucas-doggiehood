...
namespace Doggiehood.Unity.EditModeTests
{
    public class CameraRigTests
    {
        ...
        [Test]
        public void AppliesTheFixedIsometricAngle()
        {
            // #21: camera rotation/projection match the documented constants.
            ...
            Assert.That(euler.y, Is.EqualTo(CameraRigConfig.YawDegrees).Within(0.01f));
        ...
        {
            // #20: a drag pans via GestureMapper -> CameraController.
            var expected = GestureMapper.DragToPan(100f, 0f, rig.Controller.Zoom, 1000f);
